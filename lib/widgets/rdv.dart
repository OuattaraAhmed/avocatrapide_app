import 'package:avocat/screens/tabs_screen.dart';
...
class _AuthFormState extends State<AuthForm> {
  ...
  void _addUser() {
    var url = "http://bad-event.com/avocatrapide/addUsers.php";
    http.post(url, body: {
  ...
  Future<String> _login() async {
    final response =
        await http.post('http://bad-event.com/avocatrapide/loginUsers.php', body: {
      "userName": userNameController.text,
      "passWord": passWordController.text,
    });
