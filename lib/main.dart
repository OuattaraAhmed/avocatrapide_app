import 'package:avocat/screens/map_screen.dart';
import 'package:avocat/screens/pharm_details_screen.dart';
import 'package:avocat/screens/pharm_screen.dart';
import 'package:avocat/screens/splash_screen.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      initialRoute: '/',
      routes: {
        '/': (ctx) =>SplashScreen(), //SplashScreen,VilleScreen
